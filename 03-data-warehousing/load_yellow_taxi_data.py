# Description: This script downloads the yellow taxi data for the first 6 months of 2024 from the cloudfront server and uploads it to a GCS bucket.
...
if __name__ == "__main__":
    ...
    for month in MONTHS:
        ...
        if file_path:
            ...
            # Clean up each file after upload
